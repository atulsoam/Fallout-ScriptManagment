        ...
        <div className="max-w-6xl mx-auto mt-8 px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5 bg-white p-6 rounded-lg shadow-md">
                    <div>
                        <label className="block font-medium text-gray-700">To (comma separated)</label>
                        <input
                            type="text"
                            name="receiverList"
                    ...
                    <div>
                        <label className="block font-medium text-gray-700">CC (optional)</label>
                        <input
                            type="text"
                            name="ccList"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block font-medium text-gray-700">Info Link (optional)</label>
                            <input
                                type="url"
                                name="infoLink"
                                value={form.infoLink}
                        ...
                        <div>
                            <label className="block font-medium text-gray-700">Information Text (optional)</label>
                            <input
                                type="text"
                                name="information"
                    ...
                    {message && (
                        <div
                            className={`mt-4 px-4 py-3 rounded text-sm font-medium ${message.type === 'success'
                ...
                <div className="bg-gray-50 rounded-lg p-4 shadow-sm">
                    <h3 className="text-lg font-semibold text-gray-700 mb-4">📩 Live Email Preview</h3>
                    <EmailPreview
